(function (app) {
    ...
    function membershipService(apiService, notificationService, $http, $base64, $cookieStore, $rootScope) {
        ...
        function saveCredentials(usuario, nomeUsuario, faturaVenceu) {
            ...
            $cookieStore.put('repositoryFraRefresh', $rootScope.repository);

            if (usuario.LembraMe) {
                if (localStorage != null && JSON != null) {
                    localStorage["repositoryFra"] = JSON.stringify($rootScope.repository);
                }
            }
        ...
        function removeCredentials() {
            $rootScope.repository = {};
            $cookieStore.remove('repositoryFraRefresh');
            localStorage.removeItem('repositoryFra');
        ...
        function isUserLoggedIn() {
            ...
            var repUser = localStorage != null ? localStorage["repositoryFra"] : null;
