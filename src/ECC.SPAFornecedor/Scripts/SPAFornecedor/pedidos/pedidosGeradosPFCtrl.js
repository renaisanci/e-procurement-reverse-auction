(function (app) {
	...
	app.controller('pedidosGeradosPFCtrl', pedidosGeradosPFCtrl);

	pedidosGeradosPFCtrl.$inject = ['$scope', 'membershipService', 'notificationService', '$rootScope', '$location', 'apiService', '$stateParams', '$modal', '$filter', 'SweetAlert'];

	function pedidosGeradosPFCtrl($scope, membershipService, notificationService, $rootScope, $location, apiService, $stateParams, $modal, $filter, SweetAlert) {
        ...
        $scope.DtDe = date;
        //console.log(date);
        $scope.pageClass = 'page-pedidosGeradosPFCtrl';
		...
		function loadPedidos(page) {
			...
			apiService.get('/api/pedido/pedidosFornecedorAndamentoPf', config,
                loadPedidosSucesso,
                loadPedidosFalha);
        }
        ...
        $scope.despachoParaEntrega= function despachoParaEntrega(itensPedido) {
