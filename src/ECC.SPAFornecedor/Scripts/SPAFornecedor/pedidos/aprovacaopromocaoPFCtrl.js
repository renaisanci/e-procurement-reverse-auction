...
(function (app) {
	...
	app.controller('aprovacaopromocaoPFCtrl', aprovacaopromocaoPFCtrl);

	aprovacaopromocaoPFCtrl.$inject = ['$scope', '$timeout', 'apiService', 'notificationService', '$stateParams', 'SweetAlert', '$modal'];

	function aprovacaopromocaoPFCtrl($scope, $timeout, apiService, notificationService, $stateParams, SweetAlert, $modal) {
