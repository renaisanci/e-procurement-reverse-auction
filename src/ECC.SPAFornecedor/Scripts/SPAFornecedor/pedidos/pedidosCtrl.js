(function (app) {
    ...
    pedidosCtrl.$inject = ['$scope', '$timeout', 'apiService', 'notificationService', '$stateParams', 'SweetAlert', '$modal', '$rootScope'];

    function pedidosCtrl($scope, $timeout, apiService, notificationService, $stateParams, SweetAlert, $modal, $rootScope) {

        $scope.pageClass = 'page-pedido';
