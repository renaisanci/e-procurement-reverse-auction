(function (app) {
    ...
    function membershipService(apiService, notificationService, $http, $base64, $cookieStore, $rootScope) {
        ...
        function saveCredentials(usuario, nomeUsuario, faturaVenceu) {
            ...
            $cookieStore.put('repositoryFornRefresh', $rootScope.repository);

            if (usuario.LembraMe) {
                if (localStorage != null && JSON != null) {
                    localStorage["repositoryForn"] = JSON.stringify($rootScope.repository);
                }
            }
        }
        ...
        function removeCredentials() {
            $rootScope.repository = {};
            $cookieStore.remove('repositoryFornRefresh');
            localStorage.removeItem('repositoryForn');
        ...
        function isUserLoggedIn() {
            ...
            var repUser = localStorage != null ? localStorage["repositoryForn"] : null;
