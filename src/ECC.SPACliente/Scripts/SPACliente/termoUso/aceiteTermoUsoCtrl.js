...
(function (app) {
    ...
    aceiteTermoUsoCtrl.$inject = ['$scope', '$sce', '$location', '$modalInstance', '$timeout', 'apiService', 'membershipService', 'SweetAlert', '$modal'];

    function aceiteTermoUsoCtrl($scope, $sce, $location, $modalInstance, $timeout, apiService, membershipService, SweetAlert, $modal) {
        ...
        function recusar() {
            ...
            SweetAlert.swal({
                title: "Para usar a plataforma, é necessário aceitar o Termo de Uso e a Politica de Privacidade.\nCaso não aceite você será deslogado do sistema.\nTem certeza que deseja sair do sistema?",
                text: "",
                type: "warning",
